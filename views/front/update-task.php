...
<div class="container mb-5">
    <h1>Görev Güncelleme</h1>
     ...
     <form action="/update/task/<?php echo $id; ?>" method="POST">
         ...
         <div class="button-group">
            <button type="submit" class="duzenle-btn">Düzenle</button>
...
<style>
    ...
    .geri-don-btn:hover, .duzenle-btn:hover {
        opacity: 0.9;
        color: white;
    }
</style>
